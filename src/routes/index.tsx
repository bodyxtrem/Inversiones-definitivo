...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Más de 20 años ofreciendo soluciones inmobiliarias y financieras: adelantamos hasta el 50% del valor de venta, pagamos tu hipoteca y no cobras hasta vender." },
...
const content = {
  es: {
    ...
    bullets: [
      ...
      "Adelantamos hasta el 50% del valor de venta",
...
Nuestras operaciones están respaldadas por el propio inmueble, reduciendo el riesgo al máximo." },
    ...
    advs: [
      ...
      { t: "Seguridad", s: "Más de 10 años de experiencia", d: "Dos décadas de experiencia avalan la seguridad y eficacia de nuestro método." },
    ],
    servEyebrow: "Nuestros servicios",
    servTitle: "Soluciones inmobiliarias y financieras a medida",
    servText: "Grupo Royal es garantía, experiencia y eficacia. Ofrecemos soluciones inmobiliarias y financieras para resolver cada operación de forma ágil, segura y eficiente.",
    servLink: "Ver todos los servicios",
    servs: [
      { t: "Venta de inmueble", d: "Adelantamos hasta el 50% del valor de venta." },
      { t: "Herencias", d: "Adelantamos los gastos para aceptar tu herencia." },
      { t: "Embargos", d: "Liquidamos embargos para facilitar la venta." },
      { t: "Renta vitalicia", d: "Cobra el importe completo en un solo pago." },
    ],
