...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Royal Group — Especialistas en soluciones inmobiliarias estratégicas en Barcelona" },
      { name: "description", content: "Más de 10 años ofreciendo soluciones inmobiliarias y financieras: adelantamos hasta el 50% del precio de venta, pagamos tu hipoteca y no cobras hasta vender." },
...
const content = {
  es: {
    ...
    introTitle: "En Grupo Royal vamos mucho más allá de la intermediación inmobiliaria tradicional.",
    introText: "Reunimos en un mismo equipo especialistas en inversión inmobiliaria, asesoramiento jurídico, financiación y gestión patrimonial para ofrecer soluciones integrales, rápidas y con todas las garantías legales.",
    bullets: [
      "Contrato de arras en 48-72 horas",
      "Adelantamos hasta el 50% del precio de venta",
      "Pagamos tu hipoteca mientras se realiza la venta",
      "Adelantamos los gastos de tu herencia",
    ],
    tagline: "Sin costes iniciales. Nuestros honorarios solo se abonan cuando la operación se completa con éxito.",
